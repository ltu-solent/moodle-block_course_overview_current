...
/**
 * Lang strings for course_overview_current block
 *
...
$string['course_overview_current:addinstance'] = 'Add a new course overview block';
$string['course_overview_current:myaddinstance'] = 'Add a new course overview block to Dashboard';
...
$string['pluginname'] = 'Course overview current';
