...
/**
 * Move/order course functionality for course_overview_current block.
 *
...
list($courses, $sitecourses, $coursecount) = block_course_overview_current_get_sorted_courses();
...
block_course_overview_current_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));
